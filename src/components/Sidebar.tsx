import { LayoutDashboard, Users, UserCircle, FolderOpen, Activity, Bell, X, ChevronLeft, ChevronRight, Database, LogOut } from 'lucide-react';
...
export default function Sidebar({ currentPage, onNavigate, user, isOpen, onClose, onLogout }: SidebarProps) {
  // Simulasi jumlah notifikasi yang belum dibaca
  // Ubah nilai ini untuk menguji: 5, 15, 99, 150, dll.
  const [unreadCount, setUnreadCount] = useState(15);
  const [isMinimized, setIsMinimized] = useState(false);
  
  const navItems = [
    { id: 'dashboard', label: 'Dashboard', icon: LayoutDashboard },
    { id: 'clients', label: 'Klien', icon: Users },
    { id: 'accounts', label: 'Akun', icon: UserCircle },
    ...
    { id: 'master-data', label: 'Data Master', icon: Database },
  ];
